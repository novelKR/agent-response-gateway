...
export const labels = {
  en: {
    ...
    ownershipCaption: 'In the current basic configuration, the application owns tools, approvals and history. The gateway converts declared APIs and manages model transport.',
  ...
  ko: {
    ...
    ownershipCaption: '현재 기본 구성에서 애플리케이션은 도구·승인·이력을 소유합니다. 게이트웨이는 선언된 API를 변환하고 모델 전송을 관리합니다.',
