...
walk(output);
const manifest={schema:'gateway-management-web/v1',api_contract:'gateway-management-http/v1',state_contract:'gateway-management-state/v1',...provenance,source_url:'https://github.com/novelKR/agent-response-gateway',read_only:true,files};
