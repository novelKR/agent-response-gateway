//! Core semantic models and explicit conversion to portable wire values.
use crate::ir::{
    ApiProtocol, IrError,
...
pub use gateway_plugin_contract::{EDITING_PROTOCOL, MAX_FRAME, PROTOCOL};
...
/// Validate nested fields with the core's strict semantic types after wire decoding.
