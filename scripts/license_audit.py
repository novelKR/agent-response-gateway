...
MAX_PACKAGES = 4096
LOCAL_PACKAGES = {"gateway-plugin-contract": "crates/plugin-contract/Cargo.toml", "agent-response-gateway": "Cargo.toml", "gateway-usage-contract": "crates/usage-contract/Cargo.toml", "gateway-usage-recorder": "extensions/usage-recorder/Cargo.toml", "gateway-management": "crates/management/Cargo.toml", "gateway-management-runtime": "crates/management-runtime/Cargo.toml", "gateway-management-extensions": "crates/management-extensions/Cargo.toml", "gateway-management-api": "crates/management-api/Cargo.toml", "gateway-team-access": "crates/team-access/Cargo.toml", "gateway-team-http": "crates/team-http/Cargo.toml", "gateway-management-embedded": "crates/management-embedded/Cargo.toml", "gateway-management-app": "crates/management-app/Cargo.toml"}
